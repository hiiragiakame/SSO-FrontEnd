...
export default function LockData({
  openLockThongTin = false,
  setLockThongTin = null,
  selectedRow,
}) {
  const handleLockDetails = () => {
    //thực hiện Lock ở đây

    setLockThongTin();
  };
  return [
    <Dialog
      open={openLockThongTin}
      onClose={() => setLockThongTin((prevState) => !prevState)}
      maxWidth="sm"
      fullWidth
    >
          ...
          <SoftBox mb={3}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6} xl={12}>
                ...
                >
                  {`Bạn muốn thực hiện khóa ứng dụng ${

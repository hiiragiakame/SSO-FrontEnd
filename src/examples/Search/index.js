...
// import FilterClosed from "assets/images/FilterClosed.png";
import Filter from "assets/images/filter-new.png";
import FilterClosed from "assets/images/filter-close-new.png";
    ...
    <div className={className}>
      <SuiBox display="flex" sx={{ paddingBottom: "10px" }}>
        ...
        <SuiBox width="100%" display="flex" flexDirection="column">
          ...
          {isMobile && <SuiBox py={2}>{rest}</SuiBox>}
        </SuiBox>
        {/* <Snackbar
        title="Error"
